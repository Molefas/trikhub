...
- [#64](https://github.com/Molefas/trikhub/pull/64) [`29dffb0`](https://github.com/Molefas/trikhub/commit/29dffb0e345cd006519f3c42c4ca6d27a9df0c62) Thanks [@Molefas](https://github.com/Molefas)! - Add config validation warnings: gateway warns on trik load when required config is missing, CLI shows config requirements after install
